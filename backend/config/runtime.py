...
ENV_TO_SETTING = {
    ...
    "IG_PRIVATE_USERNAME": "ig_private_username",
    "IG_PRIVATE_PASSWORD": "ig_private_password",
    "INSTAGRAM_BACKEND": "instagram_backend",
    ...
    "LOCAL_SCRAPING_ONLY": "local_scraping_only",
